...
// 지역별 대표 시군구 코드 (핫 랭킹 샘플링용 — 거래량 많은 주요 구 우선)
// 참고: region.constants.ts에 전국 250개+ 시군구 코드 정의됨 (전수 조회는 quota 과다)
const REGION_SIGUNGU_MAP: Record<string, string[]> = {
  ...
  '26': ['26350', '26260'],                                      // 부산 해운대구, 동래구
  'all': ['11680', '11710', '11650', '11440', '11170', '41135'], // 전국 샘플: 거래량 상위 시군구 대표
};

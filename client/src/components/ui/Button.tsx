...
const Button = React.memo<ButtonProps>(
  ({
    ...
    const variantStyles = {
      primary:
        'bg-[#1B64DA] text-white hover:bg-blue-700 focus:ring-blue-500 disabled:bg-gray-300',
      secondary:
        'bg-white text-[#1B64DA] border border-[#1B64DA] hover:bg-blue-50 focus:ring-blue-500 disabled:bg-gray-100 disabled:text-gray-400 disabled:border-gray-300',
      ghost:

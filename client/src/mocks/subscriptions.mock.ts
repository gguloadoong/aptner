...
export const MOCK_SUBSCRIPTIONS: Subscription[] = [
  ...
  // 추가 5개 (SUB009~SUB013)
  {
    ...
    status: 'ongoing' as SubscriptionStatus,
    supplyUnits: 1284,
    type: 'general',
    areas: [
  ...
  },
  {
    ...
    startPrice: 52000,
    maxPrice: 128000,
    deadline: new Date(Date.now() + 22 * 86400000).toISOString().slice(0, 10),
    startDate: new Date(Date.now() + 18 * 86400000).toISOString().slice(0, 10),
    status: 'upcoming' as SubscriptionStatus,
    supplyUnits: 1096,
    type: 'general',
    areas: [
  ...
  },
  {
    ...
    startPrice: 29000,
    maxPrice: 72000,
    deadline: new Date(Date.now() + 29 * 86400000).toISOString().slice(0, 10),
    startDate: new Date(Date.now() + 25 * 86400000).toISOString().slice(0, 10),
    status: 'upcoming' as SubscriptionStatus,
    supplyUnits: 842,
    type: 'general',
    areas: [
  ...
  },
  {
    ...
    status: 'closed' as SubscriptionStatus,
    supplyUnits: 2037,
    type: 'general',
    areas: [

        ...
        <section className="px-5 pt-5">
          <div className="flex items-center justify-between mb-3">
            ...
            <button
              ...
              className="text-xs text-[#1B64DA] font-medium"
            >
              더보기
            </button>
          </div>
          ...
          {isSubLoading ? (
            ...
            <div className="flex gap-3 overflow-x-auto pb-2 -mx-5 px-5">
              {ongoingSubscriptions.map((sub) => (
                <div key={sub.id} className="flex-shrink-0 w-72">
...
function RegionTrendCard({ trend }: { trend: (typeof MOCK_REGION_TRENDS)[0] }) {
  ...
  return (
    <div className="bg-white rounded-xl border border-[#E5E8EB] p-3">
      <p className="text-xs font-bold text-[#191F28] mb-1">{trend.region}</p>
